package com.geemi.facelibrary.ui.scan;
...
public class ScanViewfinderView extends View {
	...
	public ScanViewfinderView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void initFinder(int pWidth, int pHeight, Handler mHandler){
		...
		marginT = mContext.getResources().getDimension(R.dimen.dp_4);
