package com.geemi.facelibrary.ui.client.widget;
...
public class WebLayout implements IWebLayout {
    ...
    public WebLayout(Activity activity) {
        ...
        mTwinklingRefreshLayout = (TwinklingRefreshLayout) LayoutInflater.from(activity).inflate(R.layout.activity_twk_web, null);
