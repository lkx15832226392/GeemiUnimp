...
import com.geemi.facelibrary.faceui.utils.BrightnessUtils;
import com.geemi.facelibrary.faceui.utils.CameraPreviewUtils;
import com.geemi.facelibrary.faceui.utils.CameraUtils;
import com.geemi.facelibrary.faceui.utils.VolumeUtils;
import com.geemi.facelibrary.faceui.widget.FaceDetectRoundView;
 ...
 * 活体检测接口
 */
public class FaceLivenessActivity extends GeemiBaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cameraFacing = getIntent().getIntExtra(KEY_CAMERA_FACING, cameraFacing);
        KLog.i("cameraFacing====="+cameraFacing);
...
//    CameraImageSource
    private Camera open() {
        ...
        while (index < numCameras) {
            ...
            cameraInfo.facing = cameraFacing;
    ...
    protected void startPreview() {
        ...
        if (cameraFacing == Camera.CameraInfo.CAMERA_FACING_FRONT){//前置置摄像头
    ...
    private int displayOrientation(Context context) {
        ...
        if (APIUtils.hasGingerbread()) {
            ...
            if (cameraFacing == Camera.CameraInfo.CAMERA_FACING_BACK){//后置摄像头
                mPreviewDegree = 360-info.orientation;
            }
