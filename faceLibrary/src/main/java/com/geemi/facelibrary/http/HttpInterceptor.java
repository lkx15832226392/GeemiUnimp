...
import static com.geemi.facelibrary.http.RetrofitClient.CUSTOM_REPEAT_REQ_PROTOCOL;
...
public final class HttpInterceptor implements Interceptor {
    ...
    public HttpInterceptor(Map<String, Long> requestIdsMap) {
        this(Logger.DEFAULT);
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        Response response;  //准备返回Response
        try {
